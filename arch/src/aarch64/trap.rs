...
#[no_mangle]
fn invalid_exception(tf: &Context, kind: TrapKind, source: TrapSource) {
    panic!(
...
#[no_mangle]
fn handle_sync_exception(tf: &mut Context) {
...
#[no_mangle]
fn handle_irq_exception(_tf: &Context) {
    todo!("handle irq exception")
